...
const OnboardingPage = () => {
 ...
 return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8" data-theme="forest">
      ...
      <div className="border border-primary/25 w-full max-w-3xl mx-auto bg-base-100 rounded-xl shadow-lg overflow-hidden">
  ...
  Complete Your Profile
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-gray-300">Native Language</span>
                </label>
                <select
                  name="nativeLanguage"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-gray-300">Learning Language</span>
                </label>
                <select
            ...
            <button className="btn btn-primary w-full" disabled={isPending} type="submit">
              {!isPending ? (
                <>
                  <NetworkIcon className="size-5 mr-2" />
                  Complete Onboarding
                </>
              ) : (
                <>
